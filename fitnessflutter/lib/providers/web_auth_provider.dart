...
/// Web için gerçek Firebase Auth + Firestore kullanan provider
class WebAuthProvider extends BaseAuthProvider {
  ...
  // Oturum durumunu ve profili yükle
  @override
  ...
  Future<app_user.User?> _loadProfile(String uid, {String? fallbackEmail, String? fallbackName}) async {
    ...
    // Firestore dokümanı yoksa minimal bir profil döndür (Auth bilgisinden)
  ...
  Future<bool> login({
    ...
    try {
      ...
      // Profili oku; yoksa minimal oluştur
      ...
      // Firestore dokümanı yoksa temel alanları yaz (ezmeden)
